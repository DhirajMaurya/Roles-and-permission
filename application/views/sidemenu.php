<?php
//permission call by session
$uperm=$this->session->userdata('uperm');



$menu="";
$submenu="";
if($this->uri->segment(1)=="EmployeeController")
{
  $menu = "emp";
  if($this->uri->segment(2)=="emp_view" || $this->uri->segment(2)=="emp_add" || $this->uri->segment(2)=="emp_edit")
  {
    $submenu = "emp_view";
  }
  else if($this->uri->segment(2)=="emp_attendance")
  {
    $submenu = "attendance";
  }
}
else if($this->uri->segment(1)=="AdminController")
{
  $menu = "admin";
  if($this->uri->segment(2)=="admin_list" || $this->uri->segment(2)=="admin_add" || $this->uri->segment(2)=="admin_edit")
  {
    $submenu = "admin_list";
  }
}
else if($this->uri->segment(1)=="RNPController"){
  $menu = "admin";
  if($this->uri->segment(2)=="view_roles"){
    $submenu = "view_roles";
  }
  else if($this->uri->segment(2)=="view_permission"){
    $submenu = "view_perm";
  }
}
?>
  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="treeview <?php echo($menu=='admin')?'active':'';?> <?php echo($this->session->userdata('urole')==2) ? 'show':'hide';?>">
          <a href="#">
        ...
        <li class="treeview <?php echo($menu=='emp')?'active':'';?>">
          <a href="#">
            <i class="fa fa-files-o"></i>
