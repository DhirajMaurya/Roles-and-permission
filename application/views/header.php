...
<head>
  ...
  <link rel="stylesheet" href="<?php echo base_url();?>template/dist/css/bootstrap-datepicker3.css">
      ...
      <div class="navbar-custom-menu">
        <ul class="nav navbar-nav">
          ...
          <li class="dropdown user user-menu">
            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
              <img src="<?php echo base_url().'imagesbook/admin_photo/'.$this->session->userdata('uphoto');?>" class="user-image" alt="User Image">
